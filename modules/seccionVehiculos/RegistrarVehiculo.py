...
marco_RegistroVehiculo = []

widgetsEntry_RegistroVehiculo = []

def RegistrarVehiculo(self, mostrar, ocultar, widgetsMarca, widgetsModelo):
    
    self.MarcoRegistroVehiculo = CTkFrame(
                                self,
                                height=670,
                                width=970,
    ...
    marco_RegistroVehiculo.append(self.MarcoRegistroVehiculo)
    
    #Titulo Principal
    self.ConductorVehiculo_label = CTkLabel(
                                    self.MarcoRegistroVehiculo,
                                    text='Registro de Conductor y Vehiculo',
    ...
    widgetsEntry_RegistroVehiculo.append(self.NombresApellidos_entry)
    ...
    widgetsEntry_RegistroVehiculo.append(self.Cedula_entry)
    ...
    widgetsEntry_RegistroVehiculo.append(self.Telefono_entry)
    ...
    widgetsEntry_RegistroVehiculo.append(self.FechaNacimiento_entry)
    ...
    widgetsEntry_RegistroVehiculo.append(self.Licencia_selector)
    ...
    widgetsEntry_RegistroVehiculo.append(self.Marca_selector)
    ...
    CTkScrollableDropdown(
                            ...
                            scrollbar_button_color=self.color_azulComboBox,
                            frame_border_width=False,
                        ).cambiarVista('Nueva Marca', self.color_blancoPrimario, self.Fuente_MontserratSemiBold_Options, mostrar[0], ocultar, widgetsMarca)
    ...
    widgetsEntry_RegistroVehiculo.append(self.Modelo_selector)
    ...
    CTkScrollableDropdown(
                            ...
                            scrollbar_button_color=self.color_azulComboBox,
                            frame_border_width=False,
                        ).cambiarVista('Nuevo Modelo', self.color_blancoPrimario, self.Fuente_MontserratSemiBold_Options, mostrar[1], ocultar, widgetsModelo)
    ...
    widgetsEntry_RegistroVehiculo.append(self.Servicio_selector)
    ...
    widgetsEntry_RegistroVehiculo.append(self.Placa_entry)
    ...
    widgetsEntry_RegistroVehiculo.append(self.Color_entry)
    ...
    widgetsEntry_RegistroVehiculo.append(self.CapacidadCarga_entry)
    ...
    widgetsEntry_RegistroVehiculo.append(self.CapacidadPersonas_entry)
